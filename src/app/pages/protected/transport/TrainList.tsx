...
import { getTrainRoutes } from '../../../../api/transportApi';
import { TrainRoute } from '../../../../types/transport';
      ...
      <PageLayout>
        ...
        <section className="px-8 lg:px-12 py-16 relative">
          <div className="max-w-5xl mx-auto">
            ...
            <h2 className="text-4xl text-white mb-2">Train Routine</h2>
            <p className="text-gray-400 mb-10">Inter-city train schedules</p>
            ...
            {!loading && !error && routes.length === 0 && (
              <div className="text-center py-20 text-gray-400">
                No train routes available right now.
              </div>
            )}
                ...
                {routes.map((route) => (
                  ...
                  >
                    <div>
                      ...
                      {route.trainName && (
                        <p className="text-[#2e9ebf] text-sm mt-1">{route.trainName}</p>
                      )}
                      {route.notes && (
