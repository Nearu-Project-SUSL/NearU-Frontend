  ...
  const transportOptions = [
    {
      ...
      route: '/transport/tuk',
      gradient: 'from-orange-600/20 via-[#2e9ebf]/10 to-orange-600/20'
    },
    {
      id: 'bus',
      title: 'Bus Routine',
      ...
      buttonIcon: Bus,
      route: '/transport/bus',
      gradient: 'from-blue-600/20 via-[#2e9ebf]/10 to-blue-600/20'
    },
    {
      id: 'train',
      title: 'Train Routine',
      ...
      gradient: 'from-green-600/20 via-[#2e9ebf]/10 to-green-600/20'
    }
  ];
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-16 animate-fadeIn">
              <h2 className="text-5xl lg:text-6xl text-white mb-6">
                ...
                <span className="text-[#2e9ebf]">go today?</span>
              </h2>
                ...
                return (
                  <div
                    ...
                    className={`group relative overflow-hidden rounded-3xl bg-gradient-to-br ${option.gradient} border-2 transition-all duration-500 hover:scale-105 cursor-pointer animate-slideUp ${
                      isHovered ? 'border-[#2e9ebf]/60 shadow-2xl shadow-[#2e9ebf]/20' : 'border-[#2e9ebf]/20 hover:border-[#2e9ebf]/40'
                    }`}
                    style={{ animationDelay: `${index * 0.15}s` }}
                  >
                    {/* Background pattern */}
                    <div className="absolute inset-0 opacity-5" style={{
                      backgroundImage: `radial-gradient(circle at 2px 2px, rgba(46, 158, 191, 0.3) 1px, transparent 0)`,
                    ...
                    <div className="relative h-80 overflow-hidden">
                      ...
                      {/* Decorative Corner */}
                      <div className="absolute top-0 right-0 w-20 h-20 bg-[#2e9ebf]/10 backdrop-blur-sm" style={{
                    ...
                    <div className="relative p-8 bg-gradient-to-br from-gray-900/95 to-black/95 backdrop-blur-sm">
                      {/* Title */}
                      <h3 className="text-3xl text-white mb-4 group-hover:text-[#2e9ebf] transition-colors duration-300">
                        {option.title}
                      </h3>
                      ...
                      <button
                        ...
                        className={`w-full py-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-3 text-lg font-medium group/btn ${
                          isHovered
                            ? 'bg-gradient-to-r from-[#2e9ebf] to-[#2e9ebf] text-black shadow-xl shadow-[#2e9ebf]/40 scale-105'
                            : 'bg-gradient-to-r from-[#2e9ebf] to-[#2e9ebf]/90 text-white shadow-lg hover:shadow-xl'
                        }`}
                      >
                    ...
                    {/* Shine effect */}
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#2e9ebf]/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 pointer-events-none"></div>
                  </div>
                );
              })}
            </div>
            ...
            {/* Bottom Info Card */}
            <div className="mt-16 bg-gradient-to-br from-[#2e9ebf]/10 to-[#2e9ebf]/10 border-2 border-[#2e9ebf]/20 rounded-3xl p-10 animate-fadeIn" style={{ animationDelay: '0.5s' }}>
            ...
            <div className="mt-12 flex flex-wrap justify-center gap-4 animate-fadeIn" style={{ animationDelay: '0.6s' }}>
              <Link 
                to="/rides" 
                className="px-6 py-3 bg-white/5 hover:bg-[#2e9ebf]/10 border border-[#2e9ebf]/20 hover:border-[#2e9ebf]/40 rounded-xl text-[#2e9ebf] transition-all hover:scale-105 duration-300"
              >
                Quick Ride Booking
              </Link>
              <Link 
