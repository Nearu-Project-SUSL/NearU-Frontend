              ...
              <Fade in={true} timeout={600}>
                <Box>
                  <Typography variant="h3" sx={{ fontWeight: 800, color: '#fff', letterSpacing: '-0.02em', mb: 2 }}>
                    Post a <span style={{ color: '#2E9EBF' }}>Job</span>
                  </Typography>
                              ...
                              <Box sx={{
                                ...
                                {logoPreview && logoInputMode === 'file' ? (
                                  <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2 }}>
                                    ...
                                    <Button variant="outlined" component="label" htmlFor="create-job-logo-change" size="small" disabled={isUploadingLogo} sx={{ color: '#fff', borderColor: 'rgba(46, 158, 191, 0.4)', textTransform: 'none', fontSize: '0.75rem', '&:hover': { borderColor: '#2E9EBF', color: '#2E9EBF' } }}>
                                      Change Image
                                  ...
                                  <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 1 }}>
                                    ...
                                    <Button variant="contained" component="label" htmlFor="create-job-logo-select" size="small" disabled={isUploadingLogo} sx={{ mt: 1, bgcolor: 'rgba(46, 158, 191, 0.15)', color: '#fff', textTransform: 'none', boxShadow: 'none', fontSize: '0.8rem', '&:hover': { bgcolor: 'rgba(46, 158, 191, 0.25)', color: '#2E9EBF' } }}>
